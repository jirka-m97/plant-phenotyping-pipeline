...
def upload_arduino(arduino_file, port="COM5", fqbn="arduino:avr:uno", arduino_cli_dir="./Arduino_cli"):
    arduino_cli_path = os.path.join(arduino_cli_dir, "arduino-cli.exe")
